...
- **No network code.** StartUPs itself opens no connections. There is no HTTP client, no socket use, and no update checker in the codebase. All network activity is performed by winget.
